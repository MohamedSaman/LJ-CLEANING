...
export default function QuotePage() {
  ...
  if (state === 'success') {
    return (
      <div style={{ background: 'linear-gradient(135deg, #EEF2FF, #DDD6FE)' }} className="min-h-screen flex items-center justify-center px-4">
        <div className="bg-white rounded-3xl p-12 max-w-lg w-full text-center shadow-xl">
          ...
          <h2 className="text-3xl font-black mb-3" style={{ fontFamily: 'var(--font-display)', color: '#1E1B4B' }}>
            Request Sent!
          </h2>
  ...
  return (
    <>
      ...
      {/* Form */}
      <section style={{ background: 'linear-gradient(135deg, #F8F7FF, #EEF2FF)' }} className="py-16">
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                {/* Personal info */}
                <div className="bg-white rounded-2xl p-7 shadow-sm" style={{ border: '1px solid rgba(107,70,193,0.1)' }}>
                  <h2 className="font-bold text-lg mb-5" style={{ fontFamily: 'var(--font-display)', color: '#1E1B4B' }}>
                    Your Details
                  </h2>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        style={{ borderColor: '#E2D9F3', color: '#1E1B4B' }}
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold uppercase tracking-wide text-slate-500 mb-1.5">
                ...
                {/* Services */}
                <div className="bg-white rounded-2xl p-7 shadow-sm" style={{ border: '1px solid rgba(107,70,193,0.1)' }}>
                  <h2 className="font-bold text-lg mb-2" style={{ fontFamily: 'var(--font-display)', color: '#1E1B4B' }}>
                    ...
                    {serviceOptions.map(s => {
                      ...
                      return (
                        <button
                          ...
                          style={selected
                            ? { background: 'linear-gradient(135deg, #6B46C1, #4F46E5)', color: 'white', transform: 'scale(1.03)' }
                            : { background: '#F3F0FF', color: '#6B46C1', border: '1px solid #DDD6FE' }
                          }
                        >
                          {selected && '✓ '}{s}
                        </button>
                    ...
                    {frequencyOptions.map(f => {
                      ...
                      return (
                        <button
                          ...
                          style={selected
                            ? { background: 'linear-gradient(135deg, #6B46C1, #4F46E5)', color: 'white' }
                            : { background: '#F3F0FF', color: '#6B46C1', border: '1px solid #DDD6FE' }
                          }
                        >
                          {f}
              ...
              <div className="space-y-5">
                <div className="bg-white rounded-2xl p-6 shadow-sm" style={{ border: '1px solid rgba(107,70,193,0.1)' }}>
                  <h3 className="font-bold text-base mb-4" style={{ fontFamily: 'var(--font-display)', color: '#1E1B4B' }}>
                    What Happens Next?
                  </h3>
                  {[
                ...
                <div className="rounded-2xl p-6" style={{ background: 'linear-gradient(135deg, #1E1B4B, #312E81)' }}>
                ...
                <div className="bg-white rounded-2xl p-6" style={{ border: '1px solid rgba(107,70,193,0.1)' }}>
                  <h3 className="font-bold text-sm mb-3" style={{ color: '#1E1B4B' }}>Prefer to reach us directly?</h3>
                  <a
